...
export default class Plugin {
  constructor(
    ...
    this.styleLibraryName = styleLibraryName || '';
    this.styleDirectory = typeof styleDirectory === 'undefined' ? 'dist' : styleDirectory;
    this.styleLibraryPath = styleLibraryPath || '';
  ...
  importMethod(methodName, file) {
    if (!this.selectedMethods[methodName]) {
      ...
      if (style === true) {
        ...
        file.addImport(`${stylePath}/style/css`, 'style');
      }
    }
